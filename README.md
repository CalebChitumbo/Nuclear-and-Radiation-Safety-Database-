...
workbook (13 Sep 2026 hand-over): 392 functional / 146 non-functional, 228
licensed, each classified Medical or Non-Medical, and **383 licences on
record** — the 379 the workbook accounts for (248 use/possession, 90 import,
22 variation, 7 transfer, 5 decommissioning, 3 export, 3 transit, 1 transport),
...
5. Seed the project:
   ...
   # verify the dashboard reads 538 / 228 / 310 / 392 functional
   ```
...
that workbook's 380 licences *less* the 13 the app already holds as dated
`licenceEvents`, see
...
- `seedBaseline` — verifies the register baseline (538 / 228 / 310 / 392 functional /
...
- [x] Seeded dashboard shows **538 total, 228 licensed, 310 unlicensed,
      392 functional, Public 69/250, Private 159/288, 383 authorisations** —
      verified by `tests/seedBaseline.test.ts` (2026 Licensing Status workbook,
      13 Sep 2026 hand-over).
